...
try {
    ...
    if(user) {
        return res.status(400).json({success: false, error: "User already exists in employee"});
    }
    ...
    res.status(200).json({success: true, employee: newEmployee, message: "Employee added successfully"});
